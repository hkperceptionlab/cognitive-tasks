...
// 이 앱은 엔진(runTask)을 쓰지 않는 독립 체험(실천 계열)이라 core/i18n.js + guided-timer-common 만
// 공유한다(core/engine.js 없음). 공유 JS(guided-timer.js)는 -common 이라 network-first 로 항상 최신.
const APP = 'guided-timer-adults';
...
const PRECACHE = [
  ...
  './icons/icon.svg',
  '../core/i18n.js',
  '../guided-timer-common/guided-timer.js',
];
