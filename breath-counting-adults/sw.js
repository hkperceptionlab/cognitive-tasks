...
// 이 앱은 엔진(runTask)을 쓰지 않는 독립 체험(실천 계열)이라 core/i18n.js + breath-counting-common 만
// 공유한다(core/engine.js 없음). 공유 JS(breath-counting.js)는 -common 이라 network-first 로 항상 최신.
const APP = 'breath-counting-adults';
...
const PRECACHE = [
  ...
  './icons/icon.svg',
  '../core/i18n.js',
  '../breath-counting-common/breath-counting.js',
];
